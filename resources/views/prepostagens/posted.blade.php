...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-green-300 p-6 mb-6">
            ...
            <form action="{{ route('prepostagens.posted') }}" method="GET"
        ...
        <div class="space-y-4">
            @forelse ($prepostagens as $prepostagem)
                <div
                    class="bg-white rounded-xl shadow-sm border border-green-300 p-6 hover:shadow-md transition duration-200">
