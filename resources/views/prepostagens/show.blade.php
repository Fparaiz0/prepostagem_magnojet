...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                    ...
                    <div class="text-center">
                        ...
                        <p class="font-medium">
                            {{
                                ...
                                ($prepostagem->code_format_informed_object == 2 ? 'Caixa' :
                                ($prepostagem->code_format_informed_object == 3 ? 'Rolo' : '-'))
                            }}
                        </p>
                    </div>
                    <div class="text-center">
                        <p class="text-xs text-gray-500">Serviço</p>
                        <p class="font-medium">{{ $prepostagem->code_service == '03220' ? 'SEDEX' : 'Desconhecido' }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        @endswitch
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div class="grid grid-cols-3 gap-2">
                        ...
                        <p class="col-span-2">{{ $prepostagem->city_sender }}/{{ $prepostagem->uf_sender }}</p>
                    </div>
                    <div class="grid grid-cols-3 gap-2">
        ...
        @endswitch
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div class="grid grid-cols-3 gap-2">
                        <p class="text-gray-500 font-medium">Endereço:</p>
                        <p class="col-span-2">
                            {{ $prepostagem->public_place_recipient }}, {{ $prepostagem->number_recipient }}
                    ...
                    <div class="grid grid-cols-3 gap-2">
                        <p class="text-gray-500 font-medium">Cidade/UF:</p>
                        <p class="col-span-2">{{ $prepostagem->city_recipient }}/{{ $prepostagem->uf_recipient }}</p>
                    </div>
                    <div class="grid grid-cols-3 gap-2">
                        <p class="text-gray-500 font-medium">CEP:</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-3 text-sm">
                        <div class="grid grid-cols-3 gap-2">
                            ...
                            <p class="col-span-2 font-mono">{{ $prepostagem->invoice_number ?: 'Não informado' }}</p>
                        </div>
                        <div class="grid grid-cols-3 gap-2">
                            <p class="text-gray-500 font-medium">Chave NFe:</p>
                            <p class="col-span-2 font-mono break-all whitespace-normal text-sm">{{ $prepostagem->nfe_key ?: 'Não informado' }}</p>
                        </div>
                        <div class="grid grid-cols-3 gap-2">
        ...
        <!-- Rodapé com Ações -->
        <div class="bg-gray-50 px-6 py-4 border-t border-blue-200 flex justify-end space-x-3">
            ...
            @can('create-prepostagem')
             <a href="{{ route('prepostagens.create') }}" class="px-4 py-2 border border-blue-300 rounded-lg text-blue-700 hover:bg-blue-100 transition-colors">
                    Cadastrar uma nova
             </a>
             @endcan
            @endif
            ...
            @switch($prepostagem->situation)
                @case(1)
                    <a href="{{ route('prepostagens.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors">
                        Voltar para lista
                    </a>
                    @break
                    
                @case(2)
                    <a href="{{ route('prepostagens.canceled') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors">
                        Voltar para lista
                    </a>
                    @break
                    
                @case(3)
                    <a href="{{ route('prepostagens.posted') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors">
                        Voltar para lista
                    </a>
                    @break
            @endswitch
