    ...
    <div class="content-wrapper">
                ...
                @can('index-prepostagem')
                    <a href="{{ route('prepostagens.index') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3 7l9 5 9-5M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                        Pré-Postadas
                    </a>
                @endcan
        ...
        <div class="space-y-4">
            @forelse ($prepostagens as $prepostagem)
                <div
                    class="bg-white rounded-xl shadow-sm border border-red-300 p-6 hover:shadow-md transition duration-200">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-4">
                        ...
                        <div>
                            <p class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Código de Rastreio
                            </p>
