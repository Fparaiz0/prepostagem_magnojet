...
@section('content')
    <div class="content-wrapper">
        ...
        <form action="{{ route('prepostagens.store') }}" method="POST"
            class="bg-white rounded-xl shadow-sm border border-blue-300 overflow-hidden">
            @csrf
            @method('POST')
            ...
            <div class="border-b border-gray-100">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="space-y-2">
                        ...
                        <div class="flex">
                            <input type="text" name="name_sender" id="name_sender" value="MAGNO JET INDUSTRIA LTDA"
                                readonly
            ...
            <div>
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="object_code" id="object_code" value="{{ old('object_code') }}"
                            required
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="code_format_informed_object" id="code_format_informed_object" required
                            ...
                            <option value="1" {{ old('code_format_informed_object') == '1' ? 'selected' : '' }}>
                                Envelope</option>
                            <option value="2" {{ old('code_format_informed_object') == '2' ? 'selected' : '' }}
                                selected>Caixa/Pacote</option>
                            <option value="3" {{ old('code_format_informed_object') == '3' ? 'selected' : '' }}>
                                Rolo/Cilindro</option>
                        </select>
                    </div>
