            ...
            <div class="p-6">
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div class="space-y-1">
                        ...
                        <p class="text-sm text-gray-800">{{ \Carbon\Carbon::parse($permission->created_at)->format('d/m/Y H:i:s') }}</p>
                    </div>
                </div>
            ...
            <div class="prose prose-sm text-gray-600">
                <ul class="space-y-2">
                    <li class="flex items-start">
                        ...
                        <span><strong>Título:</strong> Use um nome descritivo que seja fácil de entender para os usuários</span>
                    </li>
                    <li class="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                        <span><strong>Nome Interno:</strong> Use o formato snake_case (ex: create_users) e seja consistente</span>
                    </li>
                    <li class="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                        <span><strong>Padrão:</strong> Mantenha um padrão consistente em todas as permissões do sistema</span>
                    </li>
                </ul>
            </div>
        </div>
