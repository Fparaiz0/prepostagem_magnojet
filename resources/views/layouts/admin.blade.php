    ...
    <body class="bg-gray-50">
        <div class="flex h-screen">
            <aside class="hidden lg:flex lg:shrink-0">
                <div
                    class="flex flex-col w-64 bg-white shadow-xl border-r border-gray-200"
                >
                    <div
                        class="flex items-center justify-center p-6 border-b border-gray-200"
                    >
                        <img
                            src="/magnojetsidebar.png"
                            alt="Logo MagnoJet"
                            class="h-20 w-35"
                        />
                    </div>
                    ...
                    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                        @can('dashboard')
                            ...
                            >
                                <i
                                    class="fas fa-home w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500"
                                ></i>
                            ...
                            <div x-data="{ open: false }" class="w-full">
                                ...
                                >
                                    <div class="flex items-center">
                                        <i
                                            class="fas fa-tags w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500"
                                        ></i>
                        ...
                        @can('index-prepostagem')
                            <div x-data="{ open: false }" class="w-full">
                                ...
                                >
                                    <div class="flex items-center">
                                        <i
                                            class="fas fa-shipping-fast w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500"
                                        ></i>
                                ...
                                <div x-show="open" x-collapse class="ml-8 mt-1 space-y-1">
                                    @can('create-prepostagem')
                                        <a
                                            href="{{ route('prepostagens.create') }}"
                                            class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-900 transition-colors"
                                        >
                                    ...
                                    @can('canceled-prepostagem')
                                        <a
                                            href="{{ route('prepostagens.canceled') }}"
                                            class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-900 transition-colors"
                                        >
                        ...
                        <div class="pt-4">
                            ...
                            @can('index-sender')
                                ...
                                >
                                    <i
                                        class="fas fa-user-tie w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500"
                                    ></i>
                            ...
                            @can('index-recipient')
                                ...
                                >
                                    <i
                                        class="fas fa-users w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500"
                                    ></i>
                            ...
                            @can('index-packaging')
                                <a
                                    href="{{ route('packagings.index') }}"
                                    class="flex items-center px-4 py-3 text-gray-700 rounded-xl hover:bg-blue-50 hover:text-blue-600 transition-colors group"
                                >
                                    <i
                                        class="fas fa-box w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500"
                                    ></i>
                        ...
                        <div class="pt-4">
                            ...
                            @can('index-user')
                                ...
                                >
                                    <i
                                        class="fas fa-user-cog w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500"
                                    ></i>
                            ...
                            @can('index-user-status')
                                ...
                                >
                                    <i
                                        class="fas fa-user-clock w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500"
                                    ></i>
                            ...
                            @can('index-role')
                                ...
                                >
                                    <i
                                        class="fas fa-shield-alt w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500"
                                    ></i>
                            ...
                            @can('index-permission')
                                ...
                                >
                                    <i
                                        class="fas fa-key w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500"
                                    ></i>
                ...
                <header class="bg-white shadow-sm border-b border-gray-200">
                    <div class="flex items-center justify-between px-6 py-4">
                        <div class="flex items-center space-x-4">
                            ...
                            <div
                                class="hidden md:flex items-center space-x-2 text-sm text-gray-500"
                            >
                            ...
                            <div class="relative">
                                ...
                                >
                                    ...
                                    <div class="py-1">
                                        ...
                                        >
                                            <i
                                                class="fas fa-sign-out-alt w-5 h-5 mr-3"
                                            ></i>
                                            Sair do Sistema
                                        </a>
                                    </div>
        ...
        <div id="mobileSidebar" class="fixed inset-0 z-50 lg:hidden hidden">
            ...
            ></div>
            <div
                class="fixed inset-y-0 left-0 w-64 bg-white shadow-xl transform transition-transform -translate-x-full"
                id="sidebarMobile"
            >
