            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 mt-1">
                        <span
                            class="px-2 py-0.5 rounded-full text-xs font-medium {{ $packaging->active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
            ...
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-gray-800 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M20 7l-8-4-8 4m16 0v7a2 2 0 01-1 1.732l-7 4a2 2 0 01-2 0l-7-4A2 2 0 014 14V7m16 0L12 11M4 7l8 4" />
                    </svg>
                    Dimensões
                </h3>
            ...
            <div class="px-6 py-4 border-t border-blue-200 border-gray-200 bg-gray-50 flex justify-end">
                <form action="{{ route('packagings.destroy', $packaging->id) }}" method="POST">
                    ...
                    <button type="submit"
                        ...
                        class="flex items-center px-4 py-2 cursor-pointer bg-white border border-red-200 rounded-lg text-red-600 hover:bg-red-50 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
