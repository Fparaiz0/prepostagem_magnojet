            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <select name="active" id="active"
                        ...
                        <option value="0" {{ old('active', $packaging->active) == 0 ? 'selected' : '' }}>Inativo</option>
                    </select>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" step="0.01" name="height" id="height" value="{{ old('height', $packaging->height) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" step="0.01" name="width" id="width" value="{{ old('width', $packaging->width) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" step="0.01" name="length" id="length" value="{{ old('length', $packaging->length) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" step="0.01" name="diameter" id="diameter" value="{{ old('diameter', $packaging->diameter) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" step="0.01" name="weight" id="weight" value="{{ old('weight', $packaging->weight) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
