...
@section('content')
    ...
    <div class="content-header">
        ...
        <div class="flex space-x-3 mt-4 md:mt-0">
                ...
                @can('show-recipient')
                <a href="{{ route('recipients.show', ['recipient' => $recipient->id]) }}" 
        ...
        <form action="{{ route('recipients.update', ['recipient' => $recipient->id]) }}" method="POST">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $recipient->name) }}"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="cnpj" id="cnpj" value="{{ old('cnpj', $recipient->cnpj) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="cep" id="cep" value="{{ old('cep', $recipient->cep) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="uf" id="uf" value="{{ old('uf', $recipient->uf) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div class="space-y-2 md:col-span-2">
                    ...
                    <input type="text" name="public_place" id="public_place" value="{{ old('public_place', $recipient->public_place) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="number" id="number" value="{{ old('number', $recipient->number) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="complement" id="complement" value="{{ old('complement', $recipient->complement) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="neighborhood" id="neighborhood" value="{{ old('neighborhood', $recipient->neighborhood) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="city" id="city" value="{{ old('city', $recipient->city) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
