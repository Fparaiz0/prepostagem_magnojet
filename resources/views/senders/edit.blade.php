        ...
        <form action="{{ route('senders.update', ['sender' => $sender->id]) }}" method="POST">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2 md:col-span-2">
                    ...
                    <input type="text" name="public_place" id="public_place" value="{{ old('public_place', $sender->public_place) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="neighborhood" id="neighborhood" value="{{ old('neighborhood', $sender->neighborhood) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
