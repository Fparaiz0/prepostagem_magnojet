...
@section('content')
    ...
    <div class="bg-white rounded-2xl shadow-sm overflow-hidden mt-6 border border-blue-300">
        <form action="{{ route('users.store') }}" method="POST">
            ...
            <div class="px-8 py-5 border-t border-blue-300 bg-gray-50 flex flex-col sm:flex-row justify-between items-center gap-4">
                <div class="text-sm text-gray-500">
                    <span class="text-red-500">*</span> Campos obrigatórios
                </div>
                <div class="flex space-x-3">
                    <button type="submit" class="px-6 py-2.5 bg-indigo-600 text-white font-medium rounded-xl hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors shadow-sm hover:shadow-md flex items-center">
                        Cadastrar
                    </button>
                </div>
            </div>
