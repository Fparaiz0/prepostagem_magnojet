...
@section('content')
    ...
    <div class="content-header">
        ...
        <div class="flex flex-wrap gap-3">
            @can('create-user')
            <a href="{{ route('users.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex items-center">
                    ...
                    <tbody class="bg-white divide-y divide-blue-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 py-1 text-xs font-medium rounded-full {{ $user->user_status_id ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
