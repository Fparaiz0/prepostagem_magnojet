    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden slide-in">
        ...
        <div class="p-6">
            <form id="user-edit-form" action="{{ route('users.update', ['user' => $user->id]) }}" method="POST">
                ...
                <div class="flex flex-col-reverse md:flex-row justify-between items-center gap-4 mt-8 pt-6 border-t border-gray-200">
                    <a href="{{ URL::previous() }}" class="w-full md:w-auto flex items-center justify-center px-5 py-2.5 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">
                        <i class="fas fa-arrow-left mr-2"></i> Voltar
                    </a>
                    <button type="submit" class="w-full md:w-auto flex items-center justify-center px-5 py-2.5 cursor-pointer bg-blue-500 text-white rounded-lg hover:bg-primary-600 focus:ring-4 focus:ring-primary-200 transition-colors">
