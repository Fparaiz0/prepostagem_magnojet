    ...
    <div class="bg-white rounded-lg shadow-md border border-gray-200 mt-6 overflow-hidden">
        ...
        <div class="p-6">
            <p class="text-gray-700 mb-4">
                Este sistema foi desenvolvido para facilitar e otimizar o processo de preparação de envios realizados pela MagnoJet. Aqui, você pode:
            </p>

            <ul class="list-disc list-inside text-gray-700 mb-6 space-y-2 pl-4">
                @foreach ([
                    'Gerenciar ranges de etiquetas de postagem',
                    'Cadastrar e organizar remetentes e destinatários',
                    'Registrar informações de embalagens',
                    'Controlar o fluxo de pré-postagens de forma simples e eficiente',
                    'Acompanhar usuários, permissões e níveis de acesso conforme as funções da equipe'
                ] as $item)
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            Nosso objetivo é garantir mais agilidade, controle e segurança no processo logístico da empresa, oferecendo uma plataforma centralizada e intuitiva.
